...
public:
	float nms = .4;
	YOLODLL_API Detector(const char* cfg_filename, const char* weight_filename, int gpu_id = 0);
	...
	YOLODLL_API int detectResArray(image_t img, float thresh = 0.2, bool use_mean = false,bbox_t** pBoxes = NULL);
